...
public class Order {
	...
	public void upload()
	{
		uploadOrder("15223361");
	}
	public String uploadCustomer()
	{

		Client client = ClientBuilder.newClient();
		Entity payload = Entity.json("{  \"customer\": { \"email\": \"maildata@smtp1.homebase.co.uk\",    \"phone\": \""+customer.phone+"\",    \"mobile\": \""+customer.mobile+"\",    \"billing_address_attributes\": {      \"first_name\": \"Argos LTD\",      \"last_name\": \"\",      \"company\": \"Home Retail Group\",      \"address1\": \"489-499 Avebury Boulevard\",      \"address2\": \"\",      \"city\": \"Milton Keynes\",      \"country\": \""+customer.country+"\",      \"zip\": \"MK9 2NW\"    }  }}");	
